...
SAMPLE_QA = [
    {
        ...
        "generated_answer": "According to the policy, all full-time employees receive 25 days of annual leave per year.",
...
def main():
    ...
    decision = "PASS" if avgs["answer_relevance"] >= 0.6 and avgs["faithfulness"] >= 0.6 else "BLOCKED"
